...
/* USER CODE BEGIN USBPD_DPM_Notification */
  SINK_ST_Notification(PortNum, EventVal);
...
/* USER CODE BEGIN USBPD_DPM_SetDataInfo */
  SINK_ST_SetDataInfo(PortNum, DataId, Ptr, Size);
...
/* USER CODE BEGIN USBPD_DPM_SNK_EvaluateCapabilities */
  SINK_ST_EvaluateCapabilities(PortNum,
                               PtrRequestData,
                               PtrPowerObjectType);
...
/* USER CODE BEGIN USBPD_DPM_EvaluateDataRoleSwap */
  ...
  if ((USBPD_FALSE == DPM_USER_Settings[PortNum].PE_DataSwap) || ((USBPD_FALSE == DPM_USER_Settings[PortNum].PE_DR_Swap_To_DFP) && (USBPD_FALSE == DPM_USER_Settings[PortNum].PE_DR_Swap_To_UFP)))
  {
